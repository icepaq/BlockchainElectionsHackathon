...
plt.barh(["Liberal Party of Canada"],ls[0],label='Justin Trudeau', color = 'r')
plt.barh(["Conservative Party of Canada"],ls[1],label="Erin O'Toole", color = 'b')
...
labels = ["Liberal Party of Canada", "Conservative Party of Canada", "Block-Quebecois", "New Democratic Party"]
